...
class Category(models.Model):
    ...
    image = models.ImageField(upload_to="image", default="category.jpg", null=True, blank=True)
...
class Order(models.Model):
    ...
    initial_total = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, help_text="The original total before discount")  
    saved = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, null=True, blank=True, help_text="Amount saved by customer")
